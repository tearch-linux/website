parcelRequire = function(e, r, n, t) {
    ...
    "5IvP": [function(require, module, exports) {
        ...
        var h, k, T, M = null;
        if ("undefined" != typeof window ? M = window : void 0 !== e && (M = e), M && M._schedMock) {
            var g = M._schedMock;
            ...
            N.port1.onmessage = function() {
                ...
                var t = exports.unstable_now(),
                    o = !1;
                if (0 >= I - t) {
                    if (!(-1 !== n && n <= t)) return j || (j = !0, w(U)), A = e, void(F = n);
                    o = !0
                }
                if (null !== e) {
                    q = !0;
            ...
            var U = function(e) {
                if (null !== A) {
                    w(U);
                    var n = e - I + D;
                    n < D && B < D ? (8 > n && (n = 8), D = n < B ? B : n) : B = n, I = e + D, C || (C = !0, O.postMessage(void 0))
                } else j = !1
            };
            h = function(e, n) {
                A = e, F = n, q || 0 > n ? O.postMessage(void 0) : j || (j = !0, w(U))
            }, k = function() {
                A = null, C = !1, F = -1
            }
        }
        exports.unstable_ImmediatePriority = 1, exports.unstable_UserBlockingPriority = 2, exports.unstable_NormalPriority = 3, exports.unstable_IdlePriority = 5, exports.unstable_LowPriority = 4, exports.unstable_runWithPriority = function(e, n) {
            ...
            if (e = {
                    ...
                    next: null,
                    previous: null
                }, null === n) n = e.next = e.previous = e, a();
            else {
                i = null;
                var l = n;
                do {
    ...
    "vKFU": [function(require, module, exports) {
        ...
        "./bg.jpg": [
            ["bg.5e769f18.jpg", "zKKw"], "zKKw"
        ]
    }],
    "lYaF": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        ...
        var f = function(t) {
                function n() {
                    return a(this, n), c(this, o(n).apply(this, arguments))
                }
                return s(n, e.Component), r(n, [{
                    key: "render",
                    value: function() {
                        return e.default.createElement("div", {
                            ...
                            href: "https://www.6tel.net/"
                        }, e.default.createElement("div", {
                            className: "link-icon"
                        }, e.default.createElement("div", {
                            className: "link-icon-inner"
                        }, e.default.createElement("img", {
                            src: "icons/6tel.png",
                            alt: "6 Tel"
                        }))), e.default.createElement("div", {
                            className: "link-label"
                        }, "6 Tel")), e.default.createElement("a", {
                            className: "link-outer",
                            ...
                            className: "link-label"
                        }, "Amazon")), e.default.createElement("a", {
                            className: "link-outer",
                            ...
                            className: "link-label"
                        }, "Facebook")), e.default.createElement("a", {
                            className: "link-outer",
                            ...
                            className: "link-label"
                        }, "Github")), e.default.createElement("a", {
                            className: "link-outer",
                            href: "https://play.google.com/music/listen#/home"
                        }, e.default.createElement("div", {
                            className: "link-icon"
                        }, e.default.createElement("div", {
                            className: "link-icon-inner"
                            ...
                            className: "link-label"
                        }, "Music")), e.default.createElement("a", {
                            className: "link-outer",
                            ...
                            className: "link-label"
                        }, "Reddit")), e.default.createElement("a", {
                            className: "link-outer",
                            href: "https://tearch-linux.github.io/"
                        }, e.default.createElement("div", {
                            className: "link-icon"
                        }, e.default.createElement("div", {
                            className: "link-icon-inner"
                        }, e.default.createElement("img", {
                            src: "./icons/tearch.png",
                            alt: "TeArch"
                        }))), e.default.createElement("div", {
                            className: "link-label"
                        }, "TeArch")), e.default.createElement("a", {
                            className: "link-outer",
    ...
    "5kKm": [function(require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = void 0;
        ...
        var l = function(t) {
                function r() {
                    return n(this, r), u(this, a(r).apply(this, arguments))
                }
                return f(r, e.Component), i(r, [{
                    key: "handleClick",
                    value: function(e, t) {
                        this.props.removeSuggestion(e)
                    }
                }, {
                    key: "render",
                    value: function() {
                        var t = this;
                        return e.default.createElement("div", {
                            className: "suggestions-outer"
                        }, this.props.items.map(function(r, n) {
                            var o = ["suggestion"];
                            return t.props.active === n && o.push("suggestion-active"), e.default.createElement("div", {
                                key: n,
                                className: o.join(" ")
                            }, e.default.createElement("a", {
                                href: "http://" + r
    ...
    "lY9v": [function(require, module, exports) {
        ...
        var y = function(o) {
                function n(e) {
                    var t;
                    return s(this, n), (t = u(this, l(n).call(this, e))).state = {
                        inputVal: "",
                        searchHistory: [],
                        suggestions: [],
                        active: -1
                    }, t.onKeyUp = t.onKeyUp.bind(p(p(t))), t.onKeyDown = t.onKeyDown.bind(p(p(t))), t.removeSuggestion = t.removeSuggestion.bind(p(p(t))), t
                }
                return f(n, e.Component), c(n, [{
                    key: "componentDidMount",
                    value: function() {
                        localStorage.searchHistory && this.setState({
                    ...
                    value: function(e) {
                        var t = this.state.suggestions,
                            r = t[e];
                        t.splice(e, 1);
                        var o = this.state.searchHistory,
                            n = this.state.searchHistory.indexOf(r);
                        o.splice(n, 1), localStorage.searchHistory = JSON.stringify(o), this.setState({
                            suggestions: t,
                            searchHistory: o
                        })
                    }
                    ...
                    value: function(e) {
                        if (9 === e.which) {
                            if (e.preventDefault(), this.state.active >= 0) {
                                var t = this.state.active;
                                t === this.state.suggestions.length - 1 && (t = -1), t++, this.setState({
                                    active: t
                                })
                            }
                        } else if (13 === e.which) {
                            ...
                            if (this.state.active >= 0) {
                                r = "http://" + this.state.suggestions[this.state.active]
                            } else {
                                var o = this.state.inputVal;
                                if ("" === o) return;
                                if (-1 !== o.indexOf(".")) {
                                    var n = this.state.searchHistory; - 1 == n.indexOf(o) && (n.push(o), this.setState({
                                        searchHistory: n
                                    }), localStorage.searchHistory = JSON.stringify(n)), r = "http://" + o
                                } else {
                                    r = "https://www.google.com/search?q=" + o.split(" ").join("+")
                                }
                            }
                    ...
                    value: function(e) {
                        if (9 !== e.which) {
                            var t = e.target.value,
                                r = this.state.searchHistory,
                                o = [];
                            for (var n in r) r[n].startsWith(t) && o.push(r[n]);
                            "" === t && (o = []);
                            var i = 0 === o.length ? -1 : 0;
                            this.setState({
                                inputVal: t,
                                suggestions: o,
                                active: i
    ...
    "oXuJ": [function(require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.register = n, exports.unregister = i;
        ...
        function n(n) {
            if ("serviceWorker" in navigator) {
                ...
                window.addEventListener("load", function() {
                    var i = "".concat(void 0, "/service-worker.js");
                    e ? (t(i, n), navigator.serviceWorker.ready.then(function() {
        ...
        function o(e, n) {
            navigator.serviceWorker.register(e).then(function(e) {
                e.onupdatefound = function() {
                    var o = e.installing;
                    null != o && (o.onstatechange = function() {
                        "installed" === o.state && (navigator.serviceWorker.controller ? (console.log("New content is available and will be used when all tabs for this page are closed. See http://bit.ly/CRA-PWA."), n && n.onUpdate && n.onUpdate(e)) : (console.log("Content is cached for offline use."), n && n.onSuccess && n.onSuccess(e)))
                    })
                }
            }).catch(function(e) {
        ...
        function t(e, n) {
            fetch(e).then(function(t) {
                ...
                404 === t.status || null != i && -1 === i.indexOf("javascript") ? navigator.serviceWorker.ready.then(function(e) {
    ...
    "Focm": [function(require, module, exports) {
        ...
        var e = i(require("react")),
            r = i(require("react-dom"));
        require("./index.css");
        var t = i(require("./App")),
            u = n(require("./serviceWorker"));
        ...
        r.default.render(e.default.createElement(t.default, null), document.getElementById("root")), u.unregister();
    }, {
        "react": "1n8/",
        "react-dom": "NKHc",
        "./index.css": "vKFU",
